    ...
    return (
        <div className="text-center text-gray-500 dark:text-gray-400">
            <Image
                ...
                height={144}
            />
            <h3 className="mb-1 lg:text-2xl md:text-lg text-base text-black font-light tracking-tight  dark:text-white">
                {user.name ? user.name :"Unknown"}
            </h3>
            <small>Teacher</small>
            <div className="flex justify-center">
                <Badge className="w-fit uppercase">
            ...
            <ul className="flex justify-center mt-4 space-x-4">
                ...
                {user.socials.twitter?(
                    <li>
                        <a href={user.socials.twitter} target="_blank" className="text-gray-900 hover:text-gray-900 dark:hover:text-white">
